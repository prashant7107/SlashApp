 ...
 * {@link StudentFragInactive.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link StudentFragInactive#newInstance} factory method to
 * create an instance of this fragment.
 */
public class StudentFragInactive extends Fragment {
     ...
     * @return A new instance of fragment StudentFragInactive.
     */
    // TODO: Rename and change types and number of parameters
    public static StudentFragInactive newInstance(String param1, String param2) {
        StudentFragInactive fragment = new StudentFragInactive();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_student_frag_inactive, container, false);
        progressBar=view.findViewById(R.id.progressbar_multicolor);
        recyclerView=view.findViewById(R.id.rvStudetnsInactiveList);
    ...
    public ArrayList<Student> getStudents() {
        ...
        retrofit2.Call<StudentCls> call=getAllDataService.getInactiveStudentResult();
